...
module.exports = {
    ...
    TELEGRAM_BOT_USERNAME: 'jamali_md_bot',  // Badilisha kwa username yako halisi ya bot ya Telegram
    ...
    MESSAGES: {
        ...
        OWNER: `👑 *OWNER INFORMATION*\n\n📛 Name: JAMALI TECH TZ\n📞 Phone: +255 784 062 158\n\n🔗 Telegram: @JAMALI_TECH_TZ`  // Badilisha kwa username yako ya Telegram
    },
    
    // URLs
    URLS: {
        GITHUB: 'https://github.com/Jamali-md/JAMALI-MD',
        TELEGRAM_CHANNEL: 'https://t.me/jamali_md',   // Badilisha kwa link yako ya channel ya Telegram
        TELEGRAM_GROUP: 'https://t.me/jamali_md_group', // Badilisha kwa link yako ya group ya Telegram
